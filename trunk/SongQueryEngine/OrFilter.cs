...
namespace Lyra2
{
    class OrFilter : IFilter    
    {
        ...
        public OrFilter(IFilter leftFilter, IFilter rightFilter)
        {
        ...
        {
            return "OR" + Utils.WINNL + "(" + Utils.WINNL + this.leftFilter.ToString() + this.rightFilter.ToString() + ")" + Utils.WINNL;
        }
    }
}
