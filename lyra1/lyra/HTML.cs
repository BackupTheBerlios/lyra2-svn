	...
	public class HTML : Form
	{
		...
		private bool SaveHTML(ListBox box)
		{
			try
			{
				...
				links.Write("<a href=\"front.html\" target=\"content\"><img src=\"logo.jpg\" border=\"0\" alt=\"lyra HTML Liedtexte\"/></a>" +
					"<br />\n\t<br />\n\t" + "<h1>Inhaltsverzeichnis</h1>\n\n\t");
				links.Write("<span class=\"smallgr\"><b>" + this.idtext + "</b></span><br />\n\t");
				links.Write("<span class=\"smallgr\">generated by lyra " + Util.GetDate() + "</span><br />\n\t<br />\n\t<br />\n\t");
				links.Write("<table>\n\t\t");
