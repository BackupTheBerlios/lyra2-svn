...
namespace lyra2
{
	...
	public class Options : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.button8.Size = new System.Drawing.Size(64, 16);
			...
			this.richTextBox3.Location = new System.Drawing.Point(84, 76);
			...
			this.radioButton2.Location = new System.Drawing.Point(169, 136);
			...
			this.radioButton1.Location = new System.Drawing.Point(169, 152);
			...
			this.button4.Size = new System.Drawing.Size(64, 16);
			...
			this.richTextBox2.Location = new System.Drawing.Point(84, 52);
			...
			this.richTextBox1.Location = new System.Drawing.Point(84, 28);
			...
			this.label6.Text = "Basis XML-Datei (curtext.xml) finden Sie im Verzeichnis {lyra2}\\data\\, die Dokumen" +
				"tation in {lyra2}\\doc.";
			// 
			// label5
			// 
		...
		{
			lyra2.FX.FXResult fxr = lyra2.FX.ShowFX(this);
			if (fxr == lyra2.FX.FXResult.NewFile)
			{
				string filename = "";
				OpenFileDialog fd = new OpenFileDialog();
				fd.CheckPathExists = true;
				...
				fd.Title = "lyra2 - wählen Sie die auszuführende Datei";
				if (fd.ShowDialog(this) == DialogResult.OK)
				{
			...
			else if (fxr == lyra2.FX.FXResult.Delete)
			{
			...
			else if (fxr == lyra2.FX.FXResult.PictChoice)
			{
				string filename = "";
