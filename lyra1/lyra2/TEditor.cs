...
namespace lyra2
{
	...
	/// </summary>
	public class TEditor : System.Windows.Forms.Form
	{
		...
		public TEditor(ListBox lb, Song song, GUI owner) : this(lb, song, owner, null)
		{
		}
		...
		private void TEditor_Load(object sender, System.EventArgs e)
		{
		...
		private void checkBox1_Click(object sender, System.EventArgs e)
		{
			if (this.checkBox1.Checked)
			{
				if (MessageBox.Show(this, "Achtung!" + Util.NL + "Alle Formatierungen gehen verloren.",
				                    "lyra2", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) == DialogResult.OK)
				{
