...
namespace lyra2
{
	...
	public class GUI : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox2 = new lyra2.SearchTextBox();
			this.button7 = new System.Windows.Forms.Button();
			this.textBox1 = new lyra2.SearchTextBox();
			this.listBox3 = new lyra2.SongListBox();
			...
			this.listBox1 = new lyra2.SongListBox();
			this.button1 = new System.Windows.Forms.Button();
			this.button2 = new System.Windows.Forms.Button();
			this.tabPage3 = new System.Windows.Forms.TabPage();
			this.linkLabel1 = new System.Windows.Forms.LinkLabel();
			this.label3 = new System.Windows.Forms.Label();
			this.textBox3 = new lyra2.SearchTextBox();
			this.button13 = new System.Windows.Forms.Button();
			this.button12 = new System.Windows.Forms.Button();
			this.comboBox1 = new System.Windows.Forms.ComboBox();
			this.button6 = new System.Windows.Forms.Button();
			this.button4 = new System.Windows.Forms.Button();
			this.listBox2 = new lyra2.SongListBox();
			...
			this.menuItem38.Text = "&Update lyra2 Songtexte...";
		...
		private void menuItem30_Click(object sender, System.EventArgs e)
		{
			...
			if (dr == DialogResult.OK)
			{
				...
				DialogResult app = MessageBox.Show(this, msg,
				                                   "lyra2", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
				bool res = false;
		...
		private void menuItem31_Click(object sender, System.EventArgs e)
		{
			MessageBox.Show(this, "Beachten Sie bitte, dass die LTX-Datei UTF-8-codiert sein muss." + Util.NL +
				"Sie können mit dem Converter-Tool ({lyra2}\\Converter\\) selber LTX-Dateien generieren!" + Util.NL +
				"Mehr dazu finden Sie in der Hilfe (F1).",
			                "lyra2", MessageBoxButtons.OK, MessageBoxIcon.Warning);
			OpenFileDialog ofd = new OpenFileDialog();
		...
		private void menuItem28_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show(this, "Liste kann nicht gelöscht werden!" + Util.NL + "(mindestens eine Liste muss vorhanden sein)", "lyra2 Warnung",
		...
		private void menuItem38_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show(this, "Update wurde durchgeführt!" + Util.NL + "lyra2 wird jetzt neu gestartet.",
				                "lyra2 Update", MessageBoxButtons.OK, MessageBoxIcon.Information);
				this.restart();
			}
			// else cancelled
		}
		...
		private void menuItem41_Click(object sender, System.EventArgs e)
		{
			...
			if (MessageBox.Show(this, "Listen ebenfalls wieder auf den Stand" + Util.NL + "vor dem letzten Update zurücksetzen?" +
				Util.NL + Util.NL + "Vorsicht! Alle Änderungen seit dem letzten Update" + Util.NL + "gehen verloren.",
			                    "lyra2 Update", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
			{
				File.Copy(LyraUpdateView.BACKUPLIST, LyraUpdateView.LISTFILE, true);
				File.Delete(LyraUpdateView.BACKUPLIST);
			}
			MessageBox.Show(this, "Update wurde rückgängig gemacht!" + Util.NL + "lyra2 wird jetzt neu gestartet.",
			                "lyra2 Update", MessageBoxButtons.OK, MessageBoxIcon.Information);
			this.restart();
		}
		...
		private void menuItem53_Click(object sender, System.EventArgs e)
		{
			...
			sfd.Title = "Bitte geben Sie den Pfad für die Textdatei an!";
			sfd.Filter = "Textdatei|*.txt";
			sfd.FileName = "lyra2_" + DateTime.Now.ToString("ddMMyyyy") + ".txt";
			if(sfd.ShowDialog(this) == DialogResult.OK)
			{
				StreamWriter sw = new StreamWriter(sfd.FileName,false);
		...
		private void menuItem63_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				MessageBox.Show(this,
				                "Index konnte nicht neu gebildet werden!" + Util.NL +
				                "Bitte lyra2 beenden und vor dem Neustart das Verzeichnis '<lyra2>\\index' manuell löschen.",
				                "Suchindex erneuern...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
			}
		}
