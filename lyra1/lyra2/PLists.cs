...
namespace lyra2
{
	...
	public class MyList : SortedList
	{
		...
		public MyList(XmlNode myNode, IStorage storage) : base()
		{
			this.storage = storage;
			this.myNode = myNode;
				...
				(childnodes[3].Name == "Songs"))
			{
				...
				{
					Song song = this.storage.getSongById(id);
			...
			{
				throw new NotValidException("Lied-Listen wurden nicht geladen!");
			}
		}
		...
		public void RemoveSong(int index)
		{
			...
			{
				Util.MBoxError(index.ToString() + Util.NL + ex.StackTrace);
			}
		}
