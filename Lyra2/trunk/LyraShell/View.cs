...
namespace Lyra2.LyraShell
{
    ...
    public class View : Form
    {
        ...
        public void refresh()
        {
            ...
            if (song != null && song.BackgroundPicture != "")
            {
                ...
                this.BackgroundImage =
                    Util.handlePic(song.Scale, img, new Size(this.Width, this.Height), Util.KEEPRATIO, song.Transparency);
            }
            else
            {
        ...
        private void InitializeComponent()
        {
            ...
            this.menuItem3.Text = "&>>";
            this.menuItem3.Click += new System.EventHandler(this.MoveNext_Handler);
            // 
            // menuItem4
            // 
            this.menuItem4.Index = 1;
            this.menuItem4.Text = "&<<";
            this.menuItem4.Click += new System.EventHandler(this.MovePrevious_Handler);
            // 
            // menuItem6
            // 
            ...
            this.label5.Font = new System.Drawing.Font("Verdana", 65.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.label9.Font = new System.Drawing.Font("Verdana", 48F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        private void textBox1_KeyDown(object sender, KeyEventArgs ke)
        {
            ...
            {
                ISong toShow = this.owner.quickload(this.textBox1.Text);
                if (toShow != null)
                {
